        ...
        return [
            ...
            'items' => [
                ...
                [
                    'title' => 'الطلبات',
                    'root' => true,
                    'icon' => 'media/svg/icons/Layout/Layout-left-panel-2.svg', // or can be 'flaticon-home' or any flaticon-*
                    'page' => '/admin/orders',
                ],
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        [
                            ...
                            'page' => 'admin/providers/wait',
                            'label' => [
                                'type' => 'warning',
                                'value' => User::provider()->complete(0)->isComplete()->count()
                            ],
                        ],
                        [
                            'title' => 'اضافة',
...
//                ],
                [
                    ...
                    'label' => [
                        'type' => 'warning',
                        'value' => Message::whereNull('admin_id')->orWhere('admin_id',0)->count()
                    ],
                    'new-tab' => false,
                ],
                [
