...
@section('content')
    <form action="{{route('admin.'.$route.'.update',$item)}}" method="post" class="form-validate ajax-form" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-8">
            ...
            <div class="col-md-4">
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        @include('admin.partials.image',['iValue'=>$item->getImage('250')])
                    </div>
                </div>
                <br>
                <div class="card card-custom">
